...
`,
  ...
  <div style="background-color: black; display: flex; justify-content: center; align-items: center; height: 100vh; color: white; font-size: 24px; text-align: right; direction: rtl; padding: 20px;">
        <div>  
          ...
          <br> יתכן שתתבקשי לנבא תגובות של נבדקות יהודים או של נבדקות מוסלמיות. תוכלי לראות כל פעם את השם והרקע של הנבדקת שאת תגובתה את מתבקשת לשער.<br>
        </div>
  </div>
`,
...
// </div>`
  ...
  <div>
      ...
      <br>בשלב זה, נציג לך את הממוצע התגובות של נבדקות מסויימות למקבץ תמונות זה ונבקש ממך<br>
      <br> לשער מה היתה התגובה של נבדקת אחרת שביצעה את המטלה בעבר, ואז נראה לך את התגובה האמיתית של הנבדקת לתמונה. </br>
      <br>חשוב לציין, שאת המטלה הזו ביצעו נבדקות מאזורים שונים בארץ. </br>
      <br>חלק מהנבדקות הן יהודיות ישראליות מהאוניברסיטה העברית (כמוך), חלק מהנבדקות הן מוסלמיות מאוניברסיטת אל קודץ ממזרח ירושלים.</br>
      <br>יתכן שתתבקשי לנבא תגובות של נבדקות יהודיות או של נבדקות מוסלמיות. </br>
      <br>תוכלי לראות כל פעם את השם והרקע של הנבדקת שאת תגובתה את מתבקשת לשער.</br>
  </div>
  ...
  <div>
      ...
      <br>בשלב זה, נציג לך את הממוצע התגובות של נבדקים מסויימים למקבץ תמונות זה ונבקש ממך<br>
      <br> לשער מה היתה התגובה של נבדק אחר שביצע את המטלה בעבר, ואז נראה לך את התגובה האמיתית של הנבדק לתמונה. </br>
      <br>חשוב לציין, שאת המטלה הזו ביצעו נבדקים מאזורים שונים בארץ. </br>
      <br>חלק מהנבדקים הם יהודים ישראלים מהאוניברסיטה העברית (כמוך), חלק מהנבדקים הם מוסלמים מאוניברסיטת אל קודץ ממזרח ירושלים.</br>
      <br>יתכן שתתבקש לנבא תגובות של נבדקים יהודים או של נבדקים מוסלמים. </br>
      <br>תוכל לראות כל פעם את השם והרקע של הנבדק שאת תגובתו אתה מתבקש לשער.</br>
      <br>לתחילת המטלה, יש ללחוץ על מקש הרווח.</br>
  </div>
</div>`,
