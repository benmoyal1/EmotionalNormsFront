...
const extremeResponses = jsPsych.randomization.repeat(
  [[-65,1],[-75,1],[-70,1], [-72,1],[-68,1],[-74,1], [-64,1], [-69,1]]
  ,1)
const nonExtremeResponse = jsPsych.randomization.repeat(
  [[-20,0],[-17,0],[-15,0],[-22,0],[-21,0],[-19,0],[-24,0],[-16,0]],
  1);
const responsesJson = {1:extremeResponses,0:nonExtremeResponse}
const baselineImagesObject = jsPsych.randomization.repeat(
  [
    {
      "N": 57,
      "Minimum": -100,
...
const experimentImagesObject = jsPsych.randomization.repeat(
[
  {
    "N": 57,
    "Minimum": -100,
...
export {responsesJson,baselineImagesObject,experimentImagesObject};
